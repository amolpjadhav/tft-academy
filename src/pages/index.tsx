...
const FEATURES = [
  ...
  },
  {
    ...
    description: "Equip items on any champion and see exact stat breakdowns and power spikes.",
...
// ── Logo ──────────────────────────────────────────────────────────────────────
function TFTLogo({ size = 80 }: { size?: number }) {
  ...
  return (
    ...
    >
      ...
      <g transform={`translate(${cx},${cy})`}>
        ...
        {/* handle crossguards */}
        <line x1={-size*0.10} y1={size*0.10} x2={-size*0.06} y2={size*0.06}
          stroke="#a78bfa" strokeWidth="3.5" strokeLinecap="round"/>
        <line x1={size*0.06} y1={-size*0.06} x2={size*0.10} y2={-size*0.10}
          stroke="#a78bfa" strokeWidth="3.5" strokeLinecap="round"/>
      </g>
    </svg>
  );
