...
const FEATURES = [
  ...
  },
  {
    ...
    icon: "📝",
    title: "Blog & Strategy",
    description: "In-depth guides, augment breakdowns, economy tips, and comp strategy for every stage of the game.",
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen bg-bg-base text-text-primary overflow-hidden flex flex-col">
        ...
        {/* ── Hero ───────────────────────────────────────────────────── */}
        <section className="relative z-10 flex-1 flex flex-col items-center text-center px-6 pt-4 pb-8">
          ...
          >
            <TFTLogo size={72} hero />
            <div>
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl tracking-[0.12em] text-transparent bg-clip-text bg-gradient-to-b from-amber-300 via-accent-gold to-amber-600 leading-none">
                TFT SCHOOL
              </h1>
              <p className="text-text-muted text-xs tracking-[0.25em] font-medium uppercase mt-1.5">
                Master every{" "}
                <span
                  key={wordIdx}
                  className="animate-word-in inline-block text-accent-gold font-semibold"
                >
          ...
          {/* CTAs */}
          <div
            className="flex flex-col sm:flex-row items-center gap-2.5 mb-8"
            style={{
              opacity: mounted ? 1 : 0,
          ...
          >
            <Link
              href="/flashcards"
              className="inline-flex items-center gap-2 bg-accent-purple hover:bg-accent-purple/80 text-white font-semibold px-5 py-2.5 rounded-xl shadow-glow transition-all hover:shadow-[0_0_32px_rgba(124,58,237,0.5)] hover:-translate-y-0.5 text-sm"
            >
              🃏 Start with Flashcards
            </Link>
            <Link
              href="/quiz"
              className="inline-flex items-center gap-2 bg-bg-surface hover:bg-bg-elevated border border-white/10 text-text-primary font-medium px-5 py-2.5 rounded-xl transition-all hover:-translate-y-0.5 text-sm"
            >
              🧠 Take a Quiz
            </Link>
          </div>
